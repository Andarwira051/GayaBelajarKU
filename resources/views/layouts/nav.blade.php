        ...
        <div class="flex items-center justify-between p-4 border-b">
            <div class="flex items-center space-x-2">
                <div class="p-2 bg-primary-100 rounded-lg">
                    <i data-lucide="notebook-pen" class="w-6 h-6 text-blue-500"></i>
                </div>
                <h2 class="text-xm font-bold text-black">Halaman Pengajar</h2>
            </div>
                ...
                @if (auth()->user()->role === 'pengajar')
                    <li class="mb-2">
                        <a href="{{ route('pengajar.kelas.index') }}"
                            class="flex items-center p-2 rounded-lg transition-all duration-200 group {{ request()->routeIs('pengajar.kelas.index') ? 'bg-blue-600 text-white shadow-md' : 'hover:bg-gray-100' }}">
                            <i data-lucide="key"
                                class="w-5 h-5 mr-3 {{ request()->routeIs('pengajar.kelas.index') ? 'text-white' : 'text-gray-500 group-hover:text-blue-700' }}"></i>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <div class="hidden md:block text-right">
                            <span class="block text-gray-700 font-semibold text-sm">{{ auth()->user()->name }}</span>
